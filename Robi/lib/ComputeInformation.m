...
datadirpath = [folderName];
% datadirpath = ['D:\MOBILE RESEARCH\AMAL\Algorithm\for AMAL\exp_result\Result final\5rounds60peoples3\stand_long\CSC_stand_long\CSC_stand_long1\eer'];
