...
for postureCount=1
    ...
    folderNR = ['Result final retraining feature\5rounds60peoples\' posture '\' folderRoot '\'] ;
            ...
            for trainingCount = 1 : 1
                ...
                for testingCount = 1 :numel(testingPeriod)
                    ...
                    for userCount = 1:numel(userInvolved)
                        ...
                        classTestPos = ones(numOfFlick*size(testPosFeature,1),1);
                        classTestNeg = zeros(numOfFlick*size(testNegFeature,1),1);
