...
dirpath = '.';
datadirpath = ['D:\MOBILE RESEARCH\Feature Experiment\exp_result\' folderName '\eer'];
% datadirpath = ['D:\MOBILE RESEARCH\Feature Experiment\exp_result\Result final NCC Feature 2\5rounds100peoples\sit_long\NCC\NCC1\eer'];
