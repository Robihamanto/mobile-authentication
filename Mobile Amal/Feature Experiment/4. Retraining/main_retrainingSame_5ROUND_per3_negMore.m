...
folderNR = ['Result final v2\5rounds60peoples\' posture '5\' folderRoot '\'] ;
allAllavgeer=[];
 numOfNegData = 40;

% totalNumOfNegData = 59;
% totalNumOfPosData = 40;
% rng(23);
% idxNeg = randperm(totalNumOfNegData);
% rng(23);
% idxPos = randperm(totalNumOfPosData);
...
% %                     msize = numel(trainNegData);
%                     trainNegData = trainNegData(1:40, :);
                    trainNegData= [];
                    rng(45);
...
%                     trainPosData = trainHistogram(idxPos(1:40), :);
...
%                         trainPosData = [trainPosData;trainHistogram(idxPos(1:40), :)];
...
%                         load([sampleset_path_Neg '\' posture '\round_' num2str(round) '_period_' num2str(period(testingCount)-1) '_train_neg_sampleSet.mat'], 'trainNegHistogram');
                        ...
                        trainNegData = [trainNegData;trainNegDataTemp(1:40, :)];
                    end
