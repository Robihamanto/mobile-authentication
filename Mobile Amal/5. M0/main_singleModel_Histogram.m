...
sampleset_path = ['D:\Matlab\Mobile Authentication\NewDataset_HistogramFeature\DataSet'];
sampleset_path_Neg = ['D:\Matlab\Mobile Authentication\NewDataset_HistogramFeature\DataSet'];
                ...
                for testingCount = 1 :numel(testingPeriod)
                    ...
                    for userCount = 1:numel(userInvolved)
                        ...
                        if (trainingCount==testingCount)
                            ...
                            model(userCount) = Training_pureSVM (FeatureIndex, trainPosHist, trainNegHist, classifierNum,penaltyList,hiddenSizesNum);
                        end
                        ...
                        [classResult,probability] = Testing_pureSVM (FeatureIndex,testPosHist,testNegHist,model(userCount),classifierNum);
