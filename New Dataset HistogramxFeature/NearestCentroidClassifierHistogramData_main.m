    ...
    for round = 1:roundSize
        ...
        for period = periods
            ...
            for userIndex = 1:numel(usersInvolved)
                ...
                positiveTrainingData = getHistogram(trainHistogram); trainHistogram = [];
                positiveTestingData = getHistogram(testHistogram); testHistogram = [];
                ...
                if period == 3
                    ...
                    meanNegativeData{user} = getMeanTrainingData(negativeTrainingData, usedFeatureIndex);
                end
